...
CREATE TABLE [dbo].[WaterTreatmentCondenserWaterTests](
	...
	[TRASAR] [decimal](10, 5) NULL,
	[pH] [decimal](10, 5) NULL,
	[ORP] [int] NULL,
	[MAlkalinity] [int] NULL,
	[TotalHardness] [int] NULL,
	[CalciumHardness] [int] NULL,
	[Phosphonate] [decimal](10, 5) NULL,
	[OrthoPhosphate] [decimal](10, 5) NULL,
	[Polymer] [decimal](10, 5) NULL,
	[Zinc] [decimal](10, 5) NULL,
	[Azole] [decimal](10, 5) NULL,
	[FreeChlorine] [decimal](10, 5) NULL,
	[Copper] [decimal](10, 5) NULL,
	[Iron] [decimal](10, 5) NULL,
	[TotalBacteria] [int] NULL,
	[MakeupMeter] [decimal](10, 5) NULL,
	[BlowdownMeter] [decimal](10, 5) NULL,
	[WaterMeterCycles] [decimal](10, 5) NULL,
	...
	[StrokeSetting] [decimal](10, 5) NULL,
	[Tempurature] [decimal](10, 5) NULL,
