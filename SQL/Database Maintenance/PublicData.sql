BACKUP DATABASE [PublicData] TO  DISK = N'C:\OneDrive\OneDrive - UW\Backups\PublicData.bak' WITH  COPY_ONLY,  DESCRIPTION = N'Full backup to Office365 of Public Data',  RETAINDAYS = 1, NOFORMAT, INIT,  NAME = N'PublicData-Full Database Backup', SKIP, NOREWIND, NOUNLOAD, COMPRESSION,  STATS = 10, CHECKSUM
GO
...
RESTORE VERIFYONLY FROM  DISK = N'C:\OneDrive\OneDrive - UW\Backups\PublicData.bak' WITH  FILE = @backupSetId,  NOUNLOAD,  NOREWIND
GO
