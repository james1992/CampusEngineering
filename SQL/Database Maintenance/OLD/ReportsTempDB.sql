BACKUP DATABASE [ReportsTempDB] TO  DISK = N'C:\OneDrive\OneDrive - UW\Backups\ReportsTempDB.bak' WITH  COPY_ONLY,  DESCRIPTION = N'Full backup to Office365 of Reports Temp DB',  RETAINDAYS = 1, NOFORMAT, INIT,  NAME = N'ReportsTempDB-Full Database Backup', SKIP, NOREWIND, NOUNLOAD, COMPRESSION,  STATS = 10, CHECKSUM
GO
...
RESTORE VERIFYONLY FROM  DISK = N'C:\OneDrive\OneDrive - UW\Backups\ReportsTempDB.bak' WITH  FILE = @backupSetId,  NOUNLOAD,  NOREWIND
GO
