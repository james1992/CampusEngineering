...
############################################################################# 
### Description: 
###  I updated all of the input params
### 
...
MemorialFC = r"C:\Users\jamesd26.NETID\Desktop\trees\test.gdb\MemorialTrees"
...
MemorialAttachmentTable = r"C:\Users\jamesd26.NETID\Desktop\trees\test.gdb\MemorialTrees__ATTACH"
...
ImageTable         = r"Database Connections\FacilitiesMaintenance.sde\GroundsTrees__ATTACH"
...
def MemorialTreeInsertCursor(FC, Fields, TreeList):
    ...
    edit = arcpy.da.Editor(r"C:\Users\jamesd26.NETID\Desktop\trees\test.gdb")
