...
TreeViewFields = ["TREENUMBER", "Type", "SpeciesName", "CommonName", "DSH", "Height", "GlobalID", "SHAPE@"]

# Output feature class
MemorialFC = r"Database Connections\PublicData.sde\PublicTrees"
MemorialFCFields = ["TreeNumber", "TreeType", "SpeciesName", "CommonName", "DSH", "Height", "REL_GlobalID", "SHAPE@"]
...
def TreeViewSearchCursor(FC, Fields, TreeList):
    ...
    print "Number of trees being copied to public layer is: " + len(TreeList)
    del row
    del cursor
