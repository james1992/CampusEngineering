...
### October 4, 2018
### Tested same day at 8:19 am PST
...
OutputFolder        = r'C:\Users\ymharada\Desktop\OneDrive_1_10-4-2018'
...
def FileCreator(AttachmentName, BinaryInfo, FacNum, FolderLocation):
    ...
    BuildingFolders = [ name for name in os.listdir(FolderLocation) if os.path.isdir(os.path.join(os.path.sep, FolderLocation, name)) ]
